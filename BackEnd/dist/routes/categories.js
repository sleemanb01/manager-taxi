...
exports.categoriesRoutes.patch("/:categoryId", [(0, express_validator_1.check)("name").not().isEmpty()], [(0, express_validator_1.check)("roleId").not().isEmpty()], categories_1.updateCategory);
